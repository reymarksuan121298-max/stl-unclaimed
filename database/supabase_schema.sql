...
CREATE TABLE IF NOT EXISTS "Unclaimed" (
    ...
    bet_code TEXT, -- Bet type identifier (S3, L3, S2, 4D, 6D, STL)
    ...
    receiver_contact TEXT, -- Mobile number/account number of payment receiver
...
CREATE TABLE IF NOT EXISTS "OverAllCollections" (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    unclaimed_id BIGINT UNIQUE REFERENCES "Unclaimed"(id) ON DELETE CASCADE,
    teller_name TEXT NOT NULL,
    bet_number TEXT NOT NULL,
    bet_code TEXT, -- Bet type identifier (S3, L3, S2, 4D, 6D, STL)
    draw_date DATE NOT NULL,
